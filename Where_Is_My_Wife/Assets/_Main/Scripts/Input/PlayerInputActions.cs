...
namespace WIMW.Input
{
    ...
    ""controlSchemes"": []
        ...
        ~@PlayerInputActions()
        {
            UnityEngine.Debug.Assert(!m_Normal.enabled, "This will cause a leak and performance issues, PlayerInputActions.Normal.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Special.enabled, "This will cause a leak and performance issues, PlayerInputActions.Special.Disable() has not been called.");
